                            ...
                            <div className="catalog-single__container _container">
                                <div className='catalog-single__top'>
                                                ...
                                                <div className='catalog-fillters__box' onClick={(e) => { e.stopPropagation(); toggleMobileFillters("showed") }}>
                                                    ...
                                                    <div className="catalog-single__filter">
                                                        ...
                                                        <div className="catalog-single__filter-box">
                                                            {
                                                                filterBrands.length && (
                                                                    <FilterItem  title={"Производители"} values={filterBrands} id={99999} prices={prices} {...{ filterDataArray, setFilterDataArray }} />
                                                                )
                                                            }
                                                            {
                                                                categoryFiltersData?.map(fillter => (
                                                                    <FilterItem key={fillter.id} title={fillter.title} values={fillter.values} id={fillter.id} prices={prices} {...{ filterDataArray, setFilterDataArray }} />
                                                                ))
                                                            }
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="catalog-single__right">
                                        ...
                                        <div className='catalog-single__more'>
                                            <button className="show-more" onClick={() => {
                                                dispatch(fetchSortCategory({ id: sortTagsData?.filter(el => el.toggle)[0]?.id, filterData: [...filterDataArray, { 9999: [...prices] }], categoryId: singleCategoryData.id, limit: limit + 30 }))
                                                setLimit(limit + 30)
                                            }}>
