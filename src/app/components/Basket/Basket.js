                ...
                <div className="basket__buttons">
                    <a href>
                        <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width={20} height={20} rx={3} transform="matrix(-1 0 0 1 20 0)" fill="#201E1E" fillOpacity="0.1" />
                            <path d="M7.27597 5.92578H9.82422L6.99283 9.88972L9.82422 13.8537H7.27597L4.44458 9.88972L7.27597 5.92578Z" fill="#333333" />
                            <path d="M11.2408 5.92578H13.7891L10.9577 9.88972L13.7891 13.8537H11.2408L8.40943 9.88972L11.2408 5.92578Z" fill="#333333" />
                        </svg>
                        Вернуться в магазин
                    </a>
                    <a href>
                        Оформить заказ
                        <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width={20} height={20} rx={3} fill="white" fillOpacity="0.12" />
                            <path d="M12.724 5.92578H10.1758L13.0072 9.88972L10.1758 13.8537H12.724L15.5554 9.88972L12.724 5.92578Z" fill="white" />
                            <path d="M8.75919 5.92578H6.21094L9.04232 9.88972L6.21094 13.8537H8.75919L11.5906 9.88972L8.75919 5.92578Z" fill="white" />
                        </svg>
                    </a>
                </div>
            </div>
